...
<div id="container">
	...
	<div id="body">
		...
		<p>1. In the CodeIgniter "application/libraries"" folder put your "cloudinary" folder (containing the Cloudinary PHP API library) and the file called Cloudinarylib.php (this is the dummy library).</p>
		<p>2. in "Cloudinarylib.php" replace the api info with your actual api info:</p>
		<pre>
&lt;?php
defined('BASEPATH') OR exit('No direct script access allowed');
